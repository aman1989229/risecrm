...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var data = [
            {label: " <?php echo lang("new"); ?>", data: "<?php echo $new ?>" * 1, color: "#70d467"},
            {label: " <?php echo lang("open"); ?>", data: "<?php echo $open ?>" * 1, color: "#f11630"},
            {label: " <?php echo lang("closed"); ?>", data: "<?php echo $closed ?>" * 1, color: "#087cb1"}
        ];

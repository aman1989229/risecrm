...
<div class="modal-body clearfix">
    ...
    <div class="form-group ml15">
        <i class='fa fa-check-circle' style="color: #70d467;"></i> Attached <?php echo anchor(get_uri("invoices/download_pdf/" . $invoice_info->id), "Invoice-$invoice_info->id.pdf", array("target" => "_blank")); ?> 
    </div>
    ...
    $(document).ready(function() {
        ...
        $("#send-invoice-form").appForm({
            beforeAjaxSubmit: function(data) {
                var custom_message = encodeAjaxPostData($("#message").code());

...
if (!function_exists('move_temp_file')) {
    ...
    function move_temp_file($file_name, $target_path, $source_path = NULL) {

        //to make the file name unique we'll add a prefix
        $filename_prefix = uniqid("file") . "-";
...
if (!function_exists('move_files_from_temp_dir_to_permanent_dir')) {
    ...
    function move_files_from_temp_dir_to_permanent_dir($target_path = "") {
